...
abstract class AbstractPasswordValidationHandler {
    ...
    abstract PasswordRequest execute(final PasswordRequest passwordRequest);
    ...
    protected boolean hasSomeConditionOnCharacters(final String password, final IntPredicate condition) {
